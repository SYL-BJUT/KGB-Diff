...
def test(model):
    ...
    data_loader_train = DataLoader(dataset=trainset, batch_size=batch_size, num_workers=num_workers)
    data_loader_test = DataLoader(dataset=testset, batch_size=batch_size, num_workers=num_workers)
...
if __name__== "__main__" :
    ...
    parser.add_argument("--id_num", type=int, default=200,
    ...
    parser.add_argument("--redstep", type=int, default=100)

    parser.add_argument("--num_workers", type=int, default=0)

    parser.add_argument("--test_interval", type=int, default=50)
    parser.add_argument("--save_interval", type=int, default=50)  ## 200 for Multi-spec 500 for RED

    ##Training Path
    parser.add_argument("--train_set_file", type=str, default='./data/CASIA_train_PP.txt')
    parser.add_argument("--test_set_file", type=str, default='./data/CASIA_test_PP.txt')

    ##Store Path
    parser.add_argument("--des_path", type=str, default='./results/checkpoint_CASIA_PP/')
    parser.add_argument("--path_rst", type=str, default='./results/rst_test_CASIA_PP/')
    ...
    data_loader_train = DataLoader(dataset=trainset, batch_size=batch_size, num_workers=num_workers, shuffle=True)
    data_loader_test = DataLoader(dataset=testset, batch_size=128, num_workers=num_workers, shuffle=True)
